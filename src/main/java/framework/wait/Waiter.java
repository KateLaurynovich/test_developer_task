...
public class Waiter {
    ...
    public static void waitElementClickable(WebElement webElement) {
        WebDriverWait wait = new WebDriverWait(BrowserActions.getBrowser(), Integer.parseInt(PropertiesManager.getProperties("timeoutClickable")));
        wait.until(ExpectedConditions.elementToBeClickable(webElement));
    }

    public static void waitElementsVisible(List<WebElement> elements) {
        WebDriverWait listWait = new WebDriverWait(BrowserActions.getBrowser(), Integer.parseInt(PropertiesManager.getProperties("timeoutVisible")));
